 ...
 * Provee el estado de sesión y las acciones de login/logout/registro a todos los componentes.
...
/** Contexto de autenticación. No usar directamente: usar el hook `useAuth`. */
const AuthContext = createContext();

/**
 * Hook para acceder al contexto de autenticación desde cualquier componente.
 * Debe usarse dentro del árbol envuelto por `AuthProvider`.
 *
 ...
 * Verifica la sesión activa al montar el componente y expone todas las acciones de auth.
 *
...
export const AuthProvider = ({ children }) => {
    ...
    /**
     * Verifica el estado de la sesión consultando el endpoint /auth/me.
    ...
    /**
     * Inicia sesión con las credenciales provistas y actualiza el estado global.
     *
    ...
    /**
     * Cierra la sesión del usuario. Si el servidor falla, limpia el estado local igualmente.
     *
     ...
     * @returns {Promise<true>} `true` si la operación fue exitosa.
