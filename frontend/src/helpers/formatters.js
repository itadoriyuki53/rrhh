/**
 * @fileoverview Funciones de formateo para presentación de datos en la UI.
 * Maneja fechas, moneda, texto y nombres sin dependencias externas.
 * @module helpers/formatters
 */

/**
 * Formatea una fecha DATEONLY (YYYY-MM-DD) a formato legible en español argentino,
 ...
 * @returns {string} Fecha formateada como "dd de mmm de yyyy" o '-' si está vacía.
 * @example
...
/**
 * Formatea un timestamp ISO a fecha y hora local en español argentino.
 *
 * @param {string|null} dateString - Fecha ISO con hora (ej: "2024-01-15T10:30:00Z").
 * @returns {string} Fecha formateada como "dd/mm/yyyy, hh:mm" o '-' si está vacía.
 */
 ...
 * @returns {string} Valor formateado como "$1.234,56" o '-' si está vacío.
 * @example
...
/**
 * Trunca una cadena de texto a un largo máximo, agregando "..." al final.
 *
 * @param {string|null} text - Texto a truncar.
 * @param {number} [maxLength=15] - Longitud máxima antes de truncar.
 * @returns {string} Texto truncado o '-' si está vacío.
 * @example
 * truncateText('Administración General', 15); // "Administración ..."
 */
 ...
 * @example
 * formatFullName({ apellido: 'García', nombre: 'Juan' }); // "García, Juan"
 * formatFullName({ usuario: { apellido: 'López', nombre: 'Ana' } }); // "López, Ana"
 */
